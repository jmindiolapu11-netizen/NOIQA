...
export function RegisterModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div
        className={`relative w-full max-w-lg rounded-2xl shadow-2xl border p-6 animate-slide-up ${
          dark ? "bg-dark-card border-white/10" : "bg-white border-carbon/10"
        }`}
      >
        ...
        {step === 0 && (
          <>
            <h2 className={`text-lg font-semibold mb-1 ${dark ? "text-white" : "text-carbon"}`}>
